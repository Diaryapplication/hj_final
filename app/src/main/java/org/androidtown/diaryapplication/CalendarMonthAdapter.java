...
public class CalendarMonthAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (position == getSelectedPosition()) {
			...
			if(itemView.getItem().getDay() == mmCalendar.get(Calendar.DAY_OF_MONTH) && mCalendar.get(Calendar.MONTH) == mmCalendar.get(Calendar.MONTH) && mCalendar.get(Calendar.YEAR) == mmCalendar.get(Calendar.YEAR)){
